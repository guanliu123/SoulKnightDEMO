...
using EnumCenter;
using UnityEngine;
public class TriggerManager : SingletonBase<TriggerManager>
{
    private class GameObjectInfo
    {
        public TriggerType type;
        public GameObject target;
        public event TriggerAction action;
    ...
    public delegate void TriggerAction(GameObject obj);
    public TriggerManager()
    {
        ...
        EventManager.Instance.On(EventId.OnSceneChangeComplete, () =>
        {
            ClearObserver();
        });
    }

    public void RegisterObserver(TriggerType type, GameObject origin, GameObject target, TriggerAction action)
    {
    ...
    public void RegisterObserver(TriggerType type, GameObject origin, string tag, TriggerAction action)
    {
    ...
    public void RegisterObserver(TriggerType type, GameObject obj, TriggerAction action)
    {
